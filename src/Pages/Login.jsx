    ...
    <HStack  w="full" >
        ...
        <VStack spacing={5} w="100vh" padding={10}  height="100vh"  >
            ...
            <Stack textAlign="left" spacing={5}  w="full" >
             ...
             <Text fontSize="15px" color="blue" as="u" >Forget Password</Text>
        ...
        <VStack  textAlign="left" w="full" padding={100} height="100vh" bg="#ebeef9" display={{base:"none", md:"block"}}  >
            ...
            <Image width="500px" src='https://insights.hotjar.com/static/37d85d9a61db85c93d7f.png' />
            <Text  width="full"
            ...
            Check out our guides to better understand user behavior, make the right changes, improve UX, and increase conversions on your website and product.
            </Text>
